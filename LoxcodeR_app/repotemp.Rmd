...
```{r child = '/home/arnav/Desktop/newtest/LoxCodeR2022/LoxcodeR_app/chapter1.Rmd'}
```
...
### Ratio Plot
```{r results='asis',autodep=TRUE}
ggplotly(do.call(params$functions[[3]], params$inputs[[3]]),height = 6000)
```

### Both Plot
```{r results='asis',autodep=TRUE}
ggplotly(do.call(params$functions[[4]], params$inputs[[4]]),height = 6000)
```
Experiment Data
=====================================
...
```{r child = '/home/arnav/Desktop/newtest/LoxCodeR2022/LoxcodeR_app/chapter4.Rmd'}
```



```{r child = '/home/arnav/Desktop/newtest/LoxCodeR2022/LoxcodeR_app/chapter3.Rmd'}
```
...
```{r child = '/home/arnav/Desktop/newtest/LoxCodeR2022/LoxcodeR_app/chapter5.Rmd'}
```
